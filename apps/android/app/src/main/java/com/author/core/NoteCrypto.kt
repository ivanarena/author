...
class NoteCrypto(
  ...
  private fun encryptionKey(keyMaterial: String): SecretKeySpec = SecretKeySpec(sha256("author:$keyMaterial".toByteArray(UTF_8)), "AES")
  ...
  private fun fieldHash(value: String, keyMaterial: String, context: String): String = "hash:v1:${base64UrlEncode(sha256("author-field-hash:$keyMaterial:$context\u0000$value".toByteArray(UTF_8)))}"
